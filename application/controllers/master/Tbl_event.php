...
$this->form_validation->set_rules('dt[public]', '<strong>Public</strong>', 'required');
...

		{
	        ...
	        $this->datatables->select('id,title,tgleventStart,tgleventEnd,phone,harga,deskripsi,kota,alamat,minraider,maxraider,live_url,latitude,longitude,statusEvent,public,status');
