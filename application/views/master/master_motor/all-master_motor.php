 ...
 <!-- Content Wrapper. Contains page content -->
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" master_motor="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-delete">
      ...
      <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
              ...
              <form id="upload-delete" action="<?= base_url('master/Master_motor/delete') ?>">
  ...
  <script type="text/javascript">
            ...
            var table = '<table class="table table-bordered" id="mytable">'+
             ...
             $("#load-table").html(table)
              ...
              var t = $("#mytable").dataTable({
                ...
                ajax: {"url": "<?= base_url('master/Master_motor/json?status=') ?>"+status, "type": "POST"},
                    ...
                    { targets : [2],
                        ...
                        render : function (data, type, row, meta) {
                              ...
                              if(row['status']=='ENABLE'){
                                ...
                                var htmls = '<a href="<?= base_url('master/Master_motor/status/') ?>'+row['id']+'/DISABLE">'+
                                ...
                                var htmls = '<a href="<?= base_url('master/Master_motor/status/') ?>'+row['id']+'/ENABLE">'+
      ...
      function edit(id) {
            ...
            // location.href = "<?= base_url('master/Master_motor/edit/') ?>"+id;
            $("#load-form").html('loading...');
            
            $("#modal-form").modal();
            $("#title-form").html('Edit Data');
            $("#load-form").load("<?= base_url('master/Master_motor/edit/') ?>"+id);
      ...
      function create() {
            ...
            $("#load-form").load("<?= base_url('master/Master_motor/create/') ?>");
