            ...
            <div class="box-header">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="pull-right">          <a href="<?= base_url('master/Tbl_blog/create') ?>">
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" tbl_blog="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-delete">
      ...
      <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
              ...
              <form id="upload-delete" action="<?= base_url('master/Tbl_blog/delete') ?>">
  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
            ...
            var table = '<table class="table table-bordered" id="mytable">'+
                   ...
                   '       <th style="width:20px">No</th>'+'<th>Title</th>'+'<th>Deskripsi</th>'+'       <th style="width:150px">Status</th>'+
             ...
             $("#load-table").html(table)
              ...
              var t = $("#mytable").dataTable({
                ...
                ajax: {"url": "<?= base_url('master/Tbl_blog/json?status=') ?>"+status, "type": "POST"},

                columns: [

                    {"data": "id","orderable": false},{"data": "title"},{"data": "deskripsi"},
                    ...
                    { targets : [3],
                        ...
                        render : function (data, type, row, meta) {
                              ...
                              if(row['status']=='ENABLE'){
                                ...
                                var htmls = '<a href="<?= base_url('master/Tbl_blog/status/') ?>'+row['id']+'/DISABLE">'+
                                ...
                                var htmls = '<a href="<?= base_url('master/Tbl_blog/status/') ?>'+row['id']+'/ENABLE">'+
      ...
      function edit(id) {
            ...
            location.href = "<?= base_url('master/Tbl_blog/edit/') ?>"+id;
