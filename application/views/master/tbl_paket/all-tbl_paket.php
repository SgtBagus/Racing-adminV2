            ...
            <div class="box-header">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="pull-right">          <a href="<?= base_url('master/Tbl_paket/create') ?>">
                  ...
                  <a href="<?= base_url('fitur/ekspor/tbl_paket') ?>" target="_blank">
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" tbl_paket="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-delete">
      ...
      <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
              ...
              <form id="upload-delete" action="<?= base_url('master/Tbl_paket/delete') ?>">
  ...
  <div class="modal fade" id="modal-impor">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="<?= base_url('fitur/impor/tbl_paket') ?>" method="POST"  enctype="multipart/form-data">
  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
            ...
            var table = '<table class="table table-bordered" id="mytable">'+
                   ...
                   '       <th style="width:20px">No</th>'+'<th>Id Event</th>'+'<th>Title</th>'+'       <th style="width:150px">Status</th>'+
             ...
             $("#load-table").html(table)
              ...
              var t = $("#mytable").dataTable({
                ...
                ajax: {"url": "<?= base_url('master/Tbl_paket/json?status=') ?>"+status, "type": "POST"},

                columns: [

                    {"data": "id","orderable": false},{"data": "id_event"},{"data": "title"},
                    ...
                    { targets : [3],
                        ...
                        render : function (data, type, row, meta) {
                              ...
                              if(row['status']=='ENABLE'){
                                ...
                                var htmls = '<a href="<?= base_url('master/Tbl_paket/status/') ?>'+row['id']+'/DISABLE">'+
                                ...
                                var htmls = '<a href="<?= base_url('master/Tbl_paket/status/') ?>'+row['id']+'/ENABLE">'+
      ...
      function edit(id) {
            ...
            location.href = "<?= base_url('master/Tbl_paket/edit/') ?>"+id;
