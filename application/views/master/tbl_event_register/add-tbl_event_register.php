  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/Tbl_event_register/store') ?>" id="upload-create" enctype="multipart/form-data">
          ...
          <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="show_error"></div><div class="form-group">
                      ...
                      <input type="text" class="form-control" id="form-event_id" placeholder="Masukan Event Id" name="dt[event_id]">
