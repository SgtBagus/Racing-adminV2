            ...
            <div class="box-header">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="pull-right">          <a href="<?= base_url('master/Master_imagegroup/create') ?>">
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" master_imagegroup="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-delete">
      ...
      <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
              ...
              <form id="upload-delete" action="<?= base_url('master/Master_imagegroup/delete') ?>">
  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
            ...
            var table = '<table class="table table-bordered" id="mytable">'+
                   ...
                   '       <th style="width:20px">No</th>'+'<th>Id Event</th>'+'<th>Value</th>'+'<th>Public</th>'+'       <th style="width:150px">Status</th>'+
             ...
             $("#load-table").html(table)
              ...
              var t = $("#mytable").dataTable({
                ...
                ajax: {"url": "<?= base_url('master/Master_imagegroup/json?status=') ?>"+status, "type": "POST"},

                columns: [

                    {"data": "id","orderable": false},{"data": "id_event"},{"data": "value"},{"data": "public"},
                    ...
                    { targets : [4],
                        ...
                        render : function (data, type, row, meta) {
                              ...
                              if(row['status']=='ENABLE'){
                                ...
                                var htmls = '<a href="<?= base_url('master/Master_imagegroup/status/') ?>'+row['id']+'/DISABLE">'+
                                ...
                                var htmls = '<a href="<?= base_url('master/Master_imagegroup/status/') ?>'+row['id']+'/ENABLE">'+
      ...
      function edit(id) {
            ...
            location.href = "<?= base_url('master/Master_imagegroup/edit/') ?>"+id;
